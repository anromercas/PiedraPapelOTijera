...
public class UnJugador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1 align='center'>Has Jugado!! " + request.getParameter("nombreJugador")+ " Con la opción: " 
                    + request.getParameter("jugada")+"</h1>");
            ...
            out.println("<h2 align='center'>Resultado: " + resultado + "</h2>");
            out.println("</body>");
            out.println("</html>");
        }
    }
